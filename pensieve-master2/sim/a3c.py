...
# https://github.com/hongzimao/decima-sim/blob/master/utils.py#L39-L44
"""
...
class ActorNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate):
        ...
        # https://github.com/hongzimao/decima-sim/blob/master/train.py#L397-L398
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            merge_net = tflearn.merge([split_0, split_1, split_2_flat, split_3_flat, split_4_flat, split_5, split_6], 'concat')
