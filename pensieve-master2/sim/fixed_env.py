...
VIDEO_SCORE_FILE = './video_score_0'
...
class Environment:
    def __init__(self, all_cooked_time, all_cooked_bw, random_seed=RANDOM_SEED):
        ...
        with open(VIDEO_SCORE_FILE) as f:
            for line in f:
                self.video_score.append(float(line.split()[0]))
    ...
    def get_video_chunk(self, quality):
        ...
        video_score = self.video_score[self.video_chunk_counter]
